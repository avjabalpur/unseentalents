  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed inset-y-0 right-0 z-50 flex h-full w-full max-w-md flex-col gap-4 border-l border-border bg-popover p-6 text-sm text-popover-foreground shadow-2xl duration-200 outline-none data-open:animate-in data-open:slide-in-from-right data-closed:animate-out data-closed:slide-out-to-right",
          className
        )}
        {...props}
      >
